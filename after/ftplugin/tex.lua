...
-- maps
vim.api.nvim_buf_set_keymap(0, "n", "<leader>kk", "<plug>(vimtex-compile)", { noremap = false })
...
vim.api.nvim_buf_set_keymap(0, "n", "<localleader>,", "<plug>(vimtex-toc-open)", { noremap = false, desc = "TOC" })
