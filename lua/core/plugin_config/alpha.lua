...
startify.section.top_buttons.val = {
  ...
  startify.button("a", "AAS essay [working]", "<cmd>e D:/essay/subfiles/aasessay.tex<CR>"),
  startify.button("b", "usul AAS ", "<cmd>e D:/phdprop/subfiles/aasprop-id.tex<CR>"),
  startify.button("c", "essay folder", "<cmd>e D:/essay/subfiles/<CR>"),
  startify.button("d", "usul folder", "<cmd>e D:/phdprop/subfiles/<CR>"),
  startify.button("f", "usul riset", "<cmd>e D:/phdprop/subfiles/prop-en.tex<CR>"),
  startify.button("m", "Karakter [working]", "<cmd>e D:/karakterAA/karakter.tex<CR>"),
